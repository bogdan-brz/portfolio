            ...
            <div className={styles.content}>
                <div className={styles.row + " " + styles.row1}>
                    <p className={styles.text1}>
                        I started playing around in Python when I was about 12
                        years old. The most notable project of mine from that
                        period was a game of battleships played against the
                        computer.
                    </p>
                ...
                <div className={styles.row + " " + styles.row2}>
                    ...
                    <p className={styles.text2}>
                        ...
                        generation and spent some time exploring it. Working in
                        that environment left me with a good understanding of
                ...
                <div className={styles.row + " " + styles.row3}>
                    <p className={styles.text3}>
                        ...
                        websites with plain HTML, CSS, and Javascript, then I
                        picked up ReactJs, and finally NextJs.
                    </p>
                ...
                <div className={styles.row + " " + styles.row4}>
                    ...
                    <p className={styles.text4}>
                        More recently I took an interest in machine learning, so
                        I revived my python skills and worked through a few
                        online courses. My projects so far are implementations
                        of basic machine learning algorithms from scratch, and
                        deep learning networks in tensorflow.
                    </p>
                </div>
            </div>
        </div>
